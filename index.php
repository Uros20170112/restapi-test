            ...
            switch ( $("input[name=http_zahtev]:checked")[0].id){
                ...
                // prikupimo podatke koje hoćemo da pošaljemo iz forme
                    ...
                    if(tabela=="radio_novosti"){
                        ...
                        console.log(values);
                        $.ajax({
                            url: "http://localhost/rest/api/novosti/"+$("#id_novosti").val(),
                            type: "PUT",
                        ...
                        console.log(values);
                        $.ajax({
                            url: 'http://localhost/rest/api/kategorije/'+$("#id_kategorije").val(),
                            type: "PUT",
                            data: JSON.stringify(values),
                            success: function(data){
                                alert("Odgovor od servera> "+data['poruka']);
                    ...
                    if(tabela=="radio_novosti"){
                        ...
                        console.log(values);
                        $.ajax({
                            url: "http://localhost/rest/api/novosti/"+$("#brisanje").val(),
                            type: "DELETE",
                            data: JSON.stringify(values),
                            success: function(data){
                                alert("Odgovor od servera> "+data['poruka']);
                        ...
                        console.log(values);
                        $.ajax({
                            url: 'http://localhost/rest/api/kategorije/'+$("#brisanje").val(),
                            type: "DELETE",
                            data: JSON.stringify(values),
                            success: function(data){
                                alert("Odgovor od servera> "+data['poruka']);
